...
def run_experiment(train_dataset, test_dataset, tname="transfer"):
    ...
    if tname == "transfer+self":
        X_train2, Y_train2, W_train2, P_train2, I_train2, L_train2, X_test, Y_test, W_test, P_test, I_test, L_test = make_train_and_test(
            test_dataset, 0.7)
        ...
        X_train, Y_train, W_train, P_train, I_train, L_train, X_test, Y_test, W_test, P_test, I_test, L_test = make_train_and_test(
            test_dataset, 0.7)
    ...
    # print("Shape: ", X_train.shape, X_train2.shape)

    # Why? In order to construct the target samples in the training
    X_train = X_train2 + X_train
    ...
    # why? normalization shouldnot include the test dataset
    ...
    length = len(Y_train2)
    print("Shape: ", trainX.shape, testX.shape)
